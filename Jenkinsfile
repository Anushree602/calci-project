    ...
    stages {
        ...
        stage('ECRLogin') {
            steps {
                ...
                sh 'docker tag calc-project:v1 734101502228.dkr.ecr.eu-north-1.amazonaws.com/calc-project:v1'
        ...
        stage('Push to ECR') {
            steps {
                sh 'docker push 734101502228.dkr.ecr.eu-north-1.amazonaws.com/calc-project:v1'
